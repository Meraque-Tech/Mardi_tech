...
public:
    ...
    : Node("dual_rtk_odom_node")
    {
        ...
        rtk_utm_fix_pub_ = create_publisher<nav_msgs::msg::Odometry>("/rtk/odom/fix", qos);
...
private:
    ...
    nav_msgs::msg::Odometry createUtmFixOdom(double e, double n, double yaw)
    {
        nav_msgs::msg::Odometry odom;

        odom.header.stamp = now();
        odom.header.frame_id = "odom";     // UTM map frame
        odom.child_frame_id = "rtk_fix";  // virtual point
    ...
    void computeHeading()
    {
        ...
        auto utm_fix = createUtmFixOdom(x, y, yaw);
        rtk_utm_fix_pub_->publish(utm_fix);
    ...
    {
        points_marker_.header.frame_id = "odom";
    ...
    rclcpp::Publisher<nav_msgs::msg::Odometry>::SharedPtr rtk_utm_fix_pub_;
